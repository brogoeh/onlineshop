<?php
	...
	$button = "Update";
	$queryUser = mysqli_query($links, "SELECT * FROM user WHERE user_id='$user_id'");
...
<form action="<?php echo BASE_URL."module/user/action.php?user_id=$user_id"?>" method="POST">
	...
	<div class="el-form">
		...
		<span><input type="text" class="el-form"class="el-form"name="nama" value="<?php echo $nama; ?>" /></span>
	</div>	
	...
	<div class="el-form">
		<span><input type="submit" name="button" id="button" value="<?php echo $button; ?>" class="submit-my-profile" /></span>
	</div>	
</form>